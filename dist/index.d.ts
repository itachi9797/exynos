...
declare class ProcessManager {
    ...
    constructor(message: Context, content: string, exynos: Exynos, options?: ProcessOptions);
    init(): Promise<void>;
...
declare function main(message: Context, parent: Exynos): Promise<void>;

declare function exec(message: Message, parent: Exynos): Promise<void>;

declare function js(message: Context, parent: Exynos): Promise<void>;

declare function shard(message: Message, parent: Exynos): Promise<void>;

declare function jsi(message: Message, parent: Exynos): Promise<void>;

declare function curl(message: Message, parent: Exynos): Promise<void>;

declare function cat(message: Message, parent: Exynos): Promise<void>;
...
declare class Exynos {
    client: Client;
    options: ExynosOptions;
    owners: Snowflake[];
    process: never[];
    /**
     ...
     */
    constructor(client: Client, options: ExynosOptions);
    run(ctx: Context): Promise<void>;
    _addOwner(id: Snowflake): Snowflake[];
    _removeOwner(id: Snowflake): Snowflake[];
}

export { Exynos as Client, index as Commands, Context, ExynosOptions, MessageData, index$1 as Utils };
