...
export interface ExynosOptions {
  aliases?: string[];
  owners?: Snowflake[];
  prefix?: string;
  secrets?: string[];
...
class Exynos {
   ...
   */
  public constructor (public client: Client, public options: ExynosOptions) {
    ...
    if (!this.options.aliases) this.options.aliases = ['exynos', 'exy']
...
export { Exynos as Client, Utils, Commands }
